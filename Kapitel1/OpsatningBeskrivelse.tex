...
Dels er loddet påvirket af tyngdekraften. 
...
Men vi kan da omskrive til en differentialligning ved at udnytte, at $F_{fjeder}=k \cdot x(t)$ (se \ref{teori:Hooks lov}), hvor $x(t)$ er en funktion, der beskriver loddets højde i forhold til et udgangspunkt (typisk vil dette udgangspunkt være den højde loddet vil være i når det hænger stille).  
...
Fremover vil $\mu x(t)$ blive omtalt som \textit{dæmpningsledet}, da det netop er luftmodstanden, der gør, at bevægelsen ikke bliver ved for evigt, da luftmodstanden giver anledning til en dæmpning. 
